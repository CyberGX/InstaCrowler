...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Instagram Crowler")
    ...
    with InstaCrowler() as crowler:
        crowler.get_post_by_hashtag(args.hashtag, max_page=args.maxpage, max_post=args.maxpost)
